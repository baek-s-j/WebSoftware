...
<div class="container-fluid">
  <div class="row no-gutter">
    <div class="d-none d-md-flex col-md-4 col-lg-6 " style="background:url('img/logo.png'); background-repeat: no-repeat; " ></div>
            ...
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form class="modal-content animate" action="login2.jsp" method="post">
                ...
                <div class="text-center">
                  <a class="small" href="pass.jsp">비밀번호 찾기</a></div>
              </form>
            </div>
          </div>
        </div>
