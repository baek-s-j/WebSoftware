    ...
    <div class="row text-center">
      ...
      <div class="col-lg-3 col-md-6 mb-4">
       ...
       <div class="col-lg-3 col-md-6 mb-4">
          ...
          <img class="card-img-top" src="https://cdn.pixabay.com/photo/2021/04/13/11/44/tomahawk-6175482__340.jpg" onClick="location.href='door3.jsp'" width= 300px; height= 150px;>
    ...
    <div class="row text-center">
      ...
      <div class="container" >
			<div class="row">
				<div class="col">
				<ul class="pagination">
						<%if(foodDAO.getdoor("서문")%4==0){
							for(int i = 1; i < (foodDAO.getdoor("서문")/4)+1; i++){
							%><li class="page-item"><a class="page-link" href="door3.jsp?pageNumber=<%=i%>"><%=i%></a></li>
							
								
							<%}
						}
						else{
						for(int i = 1; i < (foodDAO.getdoor("서문")/4)+2; i++){
							%>
