            ...
            <div class="form-row" >
              <div class="col-12 col-md-9 mb-2 mb-md-0">
				...
				<select name=foodWhere class="form-control form-control-lg" >
              	...
              	<!-- 메인 여기서 foodcate랑 foodwhere을 받아서 방금처럼 페이지 이동하려고 할때.. 저두개 변수를 넘겨서 받고 싶은데.. 잠시만요 이해좀 해볼께요 
              	뭘 받고 싶은거죠??? foodcate와 foodwhere을 또 받아야 출력되는데.. 못받아서-->
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
            ...
            <h3>위치별 추천받기</h3>
            <p class="lead mb-0">중문, 정문, 서문, 후문 위치에 따라 추천받기</p>
          </div>
        </div>
        <div class="col-lg-4">
