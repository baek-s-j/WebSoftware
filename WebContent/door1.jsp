    ...
    <div class="row text-center">
      ...
      <div class="container" >
			<div class="row">
				<div class="col">
				<ul class="pagination">
						<%if(foodDAO.getdoor("정문")%4==0){
							for(int i = 1; i < (foodDAO.getdoor("정문")/4)+1; i++){
							%><li class="page-item"><a class="page-link" href="door1.jsp?pageNumber=<%=i%>"><%=i%></a></li>
							
								
							<%}
						}
						else{
						for(int i = 1; i < (foodDAO.getdoor("정문")/4)+2; i++){
							%>
